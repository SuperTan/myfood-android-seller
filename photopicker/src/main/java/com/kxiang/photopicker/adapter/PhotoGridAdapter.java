package com.kxiang.photopicker.adapter;
...
public class PhotoGridAdapter extends SelectableAdapter<PhotoGridAdapter.PhotoViewHolder> {
    ...
    public PhotoGridAdapter(Context context, List<PhotoDirectory> photoDirectories, ArrayList<String> orginalPhotos, int colNum, int maxCount) {
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, final int position) {
        ...
        if (getItemViewType(position) == ITEM_TYPE_PHOTO) {
            ...
            holder.vSelected.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    boolean tempToast = toggleSelection(photo, maxCount);

                    if (onItemCheckListener != null) {
                        onItemCheckListener.OnItemCheck(position, photo, tempToast,
